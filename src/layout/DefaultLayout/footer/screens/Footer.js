  ...
  return (
    <div className="footer grid">
      <div className="col-6" style={{ paddingLeft: "5%" }}>
        ...
        <div className="">
          <p style={{ maxWidth: "370px" }}>
            Vietthanhca là nguồn nhạc miễn phí bản quyền. Nâng cao dự án của bạn
            với bộ sưu tập đa dạng của chúng tôi. Đơn giản hóa quy trình cấp
            phép và giải phóng khả năng sáng tạo của bạn. Tham gia với chúng tôi
            ngay hôm nay!
          </p>
        </div>
      </div>
      ...
      <div className="col-2">
        <h3 style={{ color: "#03CE58" }}>Hỗ trợ</h3>
        <p className="text">
          Để biết các cập nhật và tin tức gần đây, hãy theo dõi nguồn cấp dữ
          liệu truyền thông xã hội của chúng tôi
        </p>
        <div className="d-none d-xl-flex gap-3">
          <i
            className="pi pi-youtube m-2"
            style={{ fontSize: "2rem", color: "#03CE58" }}
          ></i>
          <i
