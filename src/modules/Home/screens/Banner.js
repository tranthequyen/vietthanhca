      ...
      <div className="xl:col-3 hidden xl:block">
        ...
        <div className="album w-full h-full pt-3 flex flex-column">
          <p
            ...
            style={{ padding: "1.5rem 0 0 1rem", color: "#72FFAE" }}
          >
            Album yêu thích
          </p>
          <b className="text-xl" style={{ padding: "0.5rem 0 1rem 2rem" }}>
            Bài đọc hôm nay
          </b>
          <img
            className="border-round-lg"
            src="https://hinhconggiao.com/images/tranh-me-maria/maria-29.jpg"
            style={{
              width: "100%",
              height: "180px",
              width: "180px",
