      ...
      return (
            <div className='px-4'>
                  <div className="w-full h-18rem bgr_playlist border-round-2xl flex flex-column justify-content-between ">
                        <h1 className='text-5xl p-3'>NGÀI VÀ CON <br></br> DẪN DẮT CHÚNG CON</h1>
                        <div className="flex justify-content-between p-3">
                              <div className="flex gap-3 p-3">
                                    <Button icon="pi pi-play" label='PHÁT BÀI HÁT' rounded style={{ background: "#03CE58", border: 'none' }} />
                                    <Button label='THEO DÕI' rounded style={{ background: "grey", border: '  1px solid #fff', opacity: '0.9' }} />
                              </div>

                              <div className='p-3 flex flex-column align-items-center justify-content-center' style={{ background: "grey", border: '  1px solid #fff', opacity: '0.9' }}  >
                                    <b className='text-2xl' ><i className='pi pi-users  text-2xl'></i>22.000</b>
                                    <span>Lượng người nghe</span>
                              </div>
                        </div>
                  </div>
                  <br />
                  <Title title="PLAYLIST" icon='pi-angle-double-right' subTitle="Xem thêm" />
                  ...
                  <div className='pt-7'>
                        <Title title="Album kinh thánh 100 tuần" icon='pi-angle-double-right' subTitle="Xem thêm" />
