        ...
        <div className="grid pt-3 justify-content-center">
          <div className=" lg:col-3 flex flex-column align-items-center gap-5 ">
            <div className="flex   gap-4">
              ...
              <ButtonActionTrack icon="pi pi-cog" />
              <ButtonActionTrack icon="pi pi-star-fill" />
              <ButtonActionTrack icon="pi pi-arrows-v" />
            </div>
            <img
              width="80%"
          ...
          <div className="lg:col-5  xl:block">
            <h5 className="bg-default m-0 p-3 text-center border-round-3xl  text-xl">
              Lời bài hát
            </h5>
            <p>
              {" "}
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora
              maiores quam ab fugiat voluptates aperiam tenetur beatae atque
              quaerat iure fugit quo officiis, fuga deserunt alias consectetur
              laborum praesentium amet.
            </p>
          </div>
