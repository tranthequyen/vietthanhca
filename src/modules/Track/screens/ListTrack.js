      ...
      return (
            <div className='trend_regular ' style={{borderRadius:'4vh'}}>
                  <ul className='p-0 m-0 flex py-3 justify-content-center'>
                        ...
                        <div className="pl-3 flex flex-row justify-center" style={{margin:'0 auto'}}>
                            <Button 
                                    ...
                                    test.slice(0, 5).map(d =>
                                          ...
                                          <li className='flex align-items-center px-3'>
                                                ...
                                                <div className='flex flex-column justify-content-center p-3 gap-2'>
                                                      <Link to="" className='text-white no-underline text-lg font-semibold'>Con đường Chúa đã đi</Link>
                                                      <Link to="" className='text-left no-underline text-md' style={{color:'lightgrey'}}>Thế Quyền</Link>
                                                </div>
                                                {/* <Button icon="pi " /> */}
                                                <div className='flex-grow'></div>
                                            <h3 className='ml-5' style={{color:'lightgray'}}>5:21</h3>
                                          </li>
                                    )
                              }
                        </div>
